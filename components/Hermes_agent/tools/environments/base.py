...
class BaseEnvironment(ABC):
    ...
    def _quote_cwd_for_cd(cwd: str) -> str:
        ...
        # Local execution on Windows uses Git Bash. A quoted native path such
        # as ``D:\repo`` keeps its backslashes literal, so bash cannot cd and
        # the wrapper exits 126. Git Bash accepts drive paths with forward
        # slashes, including paths containing spaces after shlex quoting.
