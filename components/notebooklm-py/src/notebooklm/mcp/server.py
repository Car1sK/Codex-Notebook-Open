...
SERVER_INSTRUCTIONS = (
    ...
    "`needs_confirmation` preview. Tools prefixed `open_notebook_` manage "
    "notes on the configured Open Notebook server independently of Google "
    "NotebookLM auth. Errors arrive as `CODE: message "
    "(retriable=…)`."
)
